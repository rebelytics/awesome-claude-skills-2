...
- [Task Observer](https://github.com/rebelytics/one-skill-to-rule-them-all) - Watches work sessions, logs where your skills produce the wrong output, and turns those observations into proposed skill improvements. *By [@rebelytics](https://github.com/rebelytics)*
